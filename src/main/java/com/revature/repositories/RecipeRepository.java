...
public interface RecipeRepository extends JpaRepository<Recipe, Integer> {
    ...
    @Query(value="SELECT * FROM Recipes r WHERE LOWER(r.recipe_name) LIKE :searchTerm OR LOWER(r.category) LIKE :searchTerm OR LOWER(r.instructions) LIKE '%:searchTerm%'", nativeQuery = true)
